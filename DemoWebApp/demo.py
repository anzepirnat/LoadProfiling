...
graph1=Image.open('RoutineGraphs/1.png')
graph2=Image.open('RoutineGraphs/2.png')
graph3=Image.open('RoutineGraphs/3.png')
graph4=Image.open('RoutineGraphs/4.png')
graph5=Image.open('RoutineGraphs/5.png')
graph6=Image.open('RoutineGraphs/6.png')
graph7=Image.open('RoutineGraphs/7.png')
graph8=Image.open('RoutineGraphs/8.png')
...
st.write("It is designed to give user an insight into the last anomaly detected, its accuracy and date+time of it as it could mean an elder is unconscious and his life in danger. Accuracy provides the probability of said medical state or other causes for the described outcome.")
...
#vvvvvvvvvvvvvvvvvvv_This_is_a_workarround_to_make_the_sidebar_thinner_vvvvvvv
st.markdown(
     """
     <style>
...
if st.sidebar.button('House 1'):
    ...
    col1.caption('Note: The following personal information are fabricated for the sake of the demo')
    col1.image(UserPic)
    ...
    col3.write("Routines change. Our anomaly detection algorithm cannot anticipate that.") 
    col3.write("This graph shows you anomalies that happened last week. If newly detected anomalies coincide with the ones from last week, then they might not be anomalies, but a new routine.")
    ...
    col3.header("Routine")
    col3.write("If one were to do exact same things at the exact same time on same day each week the routine would be at 100%; our prediction 100% accurate. But that is not the case in a real world example.") 
    col3.write("The graph below shows how close the elderly are to the ideal and the probability of discovering the anomaly that is the result of it.")
    ...
    column1.write("Understanding the problem is essential when trying to fix it, thus we provide the heatmap down below.") 
    column1.write("When looking at it, know that each rectangle shows the activity of 2 hours and the color turns from black to white when the device is in use, stopping in its transformation midway with a shade of red in case it wasn't used for the whole 2h.")
    column1.image(heatmap1)
    column2.write("Try building a strong routine on all devices, using the most predictive 3 as an example.") 
    column2.write("Focus on the least predictive 3 to start with.")
    column2.subheader('Most predictive 3:')
    column2.text('washing machine')
    column2.image(graph7)
    column2.text('computer')
    column2.image(graph6)
    column2.text('television')
    column2.image(graph6)
    column2.subheader('Least predictive 3:')
    column2.text('washer dryer')
    column2.image(graph4)
    column2.text('fridge')
    column2.image(graph1)
    column2.text('freezer')
    column2.image(graph1)
...
if st.sidebar.button('House 2'):
    ...
    column2.subheader('Least predictive 3:')
    column2.text('fan')
    column2.image(graph5)
    column2.text('audio system')
    column2.image(graph3)
    column2.text('fridge freezer')
    column2.image(graph1)
...
if st.sidebar.button('House 5'):
    ...
    column2.image(graph6)
    column2.subheader('Least predictive 3:')
    column2.text('dish washer')
    column2.image(graph4)
    column2.text('computer')
    column2.image(graph2)
    column2.text('fridge freezer')
    column2.image(graph1)
...
if st.sidebar.button('House 9'):
    ...
    column2.text('kettle')
    column2.image(graph7)
    column2.text('electric space heater')
    column2.image(graph6)
    column2.text('dish washer')
    column2.image(graph6)
    column2.subheader('Least predictive 3:')
...
if st.sidebar.button('House 18'):
    ...
    column2.text('microwave')
    column2.image(graph7)
    column2.text('breadmaker')
    column2.image(graph6)
    column2.text('games console')
    column2.image(graph6)
    column2.subheader('Least predictive 3:')
    column2.text('audio system')
    column2.image(graph4)
...
if st.sidebar.button('House 20'):
    ...
    column2.text('fridge freezer')
    column2.image(graph1)
    column2.text('appliance')
    column2.image(graph1)
    column2.text('pond pump')
    column2.image(graph1)