...
if st.sidebar.button('House 1'):
    ...
    st.write("Our anomaly prediction depends heavily on the strength of the routine.")
    st.write("We suggest improving on the worst 3 devices if possible and keeping up the good routine on the best 3 devices.")
